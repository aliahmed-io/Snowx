...
export function DesktopNavbar({ user, role }: DesktopNavbarProps) {
    ...
    return (
        <>
            ...
            <div className="absolute top-0 left-[10px] z-[100] hidden md:block">
                <Link href="/" className="block transition-transform duration-500 hover:scale-110">
                    <Image
                        src="/snowx2-icon.png"
                        alt="SnowX"
                        width={160}
            ...
            >
                <div className="max-w-7xl mx-auto px-4 md:px-6 relative flex items-center justify-center">

                    <div className="w-full max-w-5xl relative flex items-center justify-between h-14 px-6 md:px-8 rounded-full transition-all duration-500 bg-snow-primary/80 backdrop-blur-xl border border-white/10 shadow-2xl">
